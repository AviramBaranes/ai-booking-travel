        ...
        <div className="space-y-5 text-sm leading-relaxed text-gray-700">
          ...
          <Section title="הפילטרים">
            ...
            <dl className="space-y-2">
              ...
              <Definition term="כרטוסים">
                האם להציג רק הזמנות שהופק עבורן שובר, או גם הזמנות שטרם כורטסו.
                כברירת מחדל מוצגות רק הזמנות מכורטסות. הזמנה שכורטסה ובוטלה
                לאחר מכן נחשבת מכורטסת, כך שהיא עדיין נספרת כשמסמנים
                &quot;כולל מבוטלות&quot;.
              </Definition>
