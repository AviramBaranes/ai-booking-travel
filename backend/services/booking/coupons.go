...
func (s *Service) ListCoupons(ctx context.Context) (*coupon.ListCouponsResponse, error) {
	cs := coupon.NewCouponService(s.query)
...
func (s *Service) CreateCoupon(ctx context.Context, p coupon.CreateCouponParams) (*coupon.CouponResponse, error) {
	cs := coupon.NewCouponService(s.query)
...
func (s *Service) UpdateCoupon(ctx context.Context, id int64, params coupon.UpdateCouponParams) (*coupon.CouponResponse, error) {
	cs := coupon.NewCouponService(s.query)
