...
type ListBrokerTranslationsParams struct {
...
func (r ListBrokerTranslationsParams) Validate() error {
	if r.Status != "" &&
...
func (s *TranslationService) ListBrokerTranslations(ctx context.Context, p ListBrokerTranslationsParams) (*ListBrokerTranslationsResponse, error) {
